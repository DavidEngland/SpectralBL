...
**Campaign Day Identifier:** 19991018**Numerical Framework:** Non-uniform Riemannian Pseudospectral Mapping ($T_n(\xi)$)

---

## 1. What This Data Is
This report analyzes the spatial and spectral initialization of the `UnifiedManifoldWorkspace` tailored for the Cooperative Atmosphere-Surface Exchange Study-1999 (CASES-99). The companion file `manifold_diagnostics_991018.csv` contains the discrete node locations ($z$) and the partition-of-unity spectral filter weights ($\psi$) for $N = 32$ modes.
