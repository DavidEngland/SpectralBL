...
* **Minimum Vertical Resolution ($\Delta z_{min}$):** 0.00285 meters (Locally dense at the surface boundary)
* **Maximum Vertical Resolution ($\Delta z_{max}$):** 9.43368 meters (Wider spacing at the upper core boundary)
