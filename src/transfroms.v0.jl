...
is_valid(m::CustomMap) = true  # Assume user-supplied map is valid; rely on unit tests for verification

# ===== UTILITY FUNCTIONS & STACK COMPOSITION  =====
# Note: profile_transform is a common utility for mapping observational height levels to computational coordinates.
